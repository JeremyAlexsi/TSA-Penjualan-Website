...
<head>
    <title>Tunas Siak Anugrah</title>
                ...
                <div class="section-menu-left">
                    ...
                    <div class="center">
                        <div class="center-item">
                            ...
                            <ul class="menu-list">
                                <li class="menu-item">
                                    <a href="{{ route('penjual.dashboard') }}" class="">
                            ...
                            <ul class="menu-list">
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{ route('penjual.products') }}" class="">
                                                <div class="text">Produk</div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{ route('penjual.brands') }}" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{ route('penjual.categories') }}" class="">
