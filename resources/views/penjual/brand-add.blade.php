        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <a href="{{ route('penjual.brand.add') }}">
            ...
            <!-- new-category -->
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('penjual.brand.store') }}" method="POST"
            ...
            @push('scripts')
                <script>
                    $(fuction() {
                        ...
                        $("input[name='name]").on("change",functiion(){
